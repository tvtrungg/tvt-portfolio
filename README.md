...
Note here that if you click [my portfolio](https://tvtrung.vercel.app/), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
